...
public class DisBaño extends Dispositivo {
	...
	/*
	 * public boolean verificarBaño() { if(personaLimpiando == true) { habilitado =
	 * false; } return habilitado; }
	 * 
	 * public String informarEstado() { String informe; if(habilitado == true) {
	 * informe= "El baño se encuentra habilitado para su uso"; }else {
